...
class LSTM(PseudoHeuristic):
    def __init__(self, name: str = 'CNN'):
        super().__init__(name=name)
        try:
            self.model = tf.keras.models.load_model(filepath="algorithms/pseudo_heuristics/models/CNNHeuristic")
    ...
    def __train__(self):
        ...
        # save the model
        model.save("algorithms/pseudo_heuristics/models/CNNHeuristic")
        self.model = model
