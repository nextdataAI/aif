...
class NN(PseudoHeuristic):
    def __init__(self, name: str = "NNHeuristic"):
        ...
        try:
            self.model = tf.keras.models.load_model(filepath="algorithms/pseudo_heuristics/models/NNHeuristic")
            with open('algorithms/pseudo_heuristics/models/NNHeuristicmax.pkl', 'rb') as file:
    ...
    def __train__(self):
        ...
        # save the model
        model.save("algorithms/pseudo_heuristics/models/NNHeuristic")
        self.model = model
        with open('algorithms/pseudo_heuristics/models/NNHeuristicmax.pkl', 'wb') as file:
